...
/// Persistentvolumeclaim resource handler
...
impl<'a> Persistentvolumeclaim<'a> {
    ...
    /// Read/describe a persistentvolumeclaim
    ///
...
mod tests {
    ...
    #[tokio::test]
    async fn test_persistentvolumeclaim_operations() {
        // Test persistentvolumeclaim CRUD operations
    }
}
