//! Apis_rbac service for Kubernetes provider
//!
...
impl<'a> Apis_rbacService<'a> {
    ...
    async fn create_rbac_authorization(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_rbac_authorization(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
    ...
    async fn delete_rbac_authorization(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
    ...
    async fn read_clusterrolebinding(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
