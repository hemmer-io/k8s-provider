//! Apis_apps service for K8s provider
//!
...
impl<'a> Apis_appsService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "daemonset" => self.plan_daemonset(current_state, desired_input).await,
            "replicaset" => self.plan_replicaset(current_state, desired_input).await,
            ...
            "statefulset" => self.plan_statefulset(current_state, desired_input).await,
            "controllerrevision" => {
                self.plan_controllerrevision(current_state, desired_input)
                    .await
            }
            "app" => self.plan_app(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_apps", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "daemonset" => self.create_daemonset(input).await,
            "replicaset" => self.create_replicaset(input).await,
            "v1" => self.create_v1(input).await,
            "statu" => self.create_statu(input).await,
            "scale" => self.create_scale(input).await,
            "statefulset" => self.create_statefulset(input).await,
            "controllerrevision" => self.create_controllerrevision(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "daemonset" => self.read_daemonset(id).await,
            "replicaset" => self.read_replicaset(id).await,
            "v1" => self.read_v1(id).await,
            "statu" => self.read_statu(id).await,
            "scale" => self.read_scale(id).await,
            "statefulset" => self.read_statefulset(id).await,
            "controllerrevision" => self.read_controllerrevision(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "daemonset" => self.update_daemonset(id, input).await,
            "replicaset" => self.update_replicaset(id, input).await,
            "v1" => self.update_v1(id, input).await,
            "statu" => self.update_statu(id, input).await,
            "scale" => self.update_scale(id, input).await,
            "statefulset" => self.update_statefulset(id, input).await,
            "controllerrevision" => self.update_controllerrevision(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "daemonset" => self.delete_daemonset(id).await,
            "replicaset" => self.delete_replicaset(id).await,
            "v1" => self.delete_v1(id).await,
            "statu" => self.delete_statu(id).await,
            "scale" => self.delete_scale(id).await,
            "statefulset" => self.delete_statefulset(id).await,
            "controllerrevision" => self.delete_controllerrevision(id).await,
    ...
    async fn create_daemonset(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a daemonset resource
    async fn read_daemonset(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a daemonset resource
    async fn update_daemonset(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a daemonset resource
    async fn delete_daemonset(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_replicaset(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a replicaset resource
    async fn read_replicaset(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a replicaset resource
    async fn update_replicaset(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a replicaset resource
    async fn delete_replicaset(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_statefulset(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a statefulset resource
    async fn read_statefulset(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a statefulset resource
    async fn update_statefulset(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a statefulset resource
    async fn delete_statefulset(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_controllerrevision(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a controllerrevision resource
    async fn read_controllerrevision(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_controllerrevision(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
