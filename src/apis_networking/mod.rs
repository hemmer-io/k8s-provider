//! Apis_networking service for Kubernetes provider
//!
...
impl<'a> Apis_networkingService<'a> {
    ...
    async fn create_networkpolicie(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
    ...
    async fn delete_networkpolicie(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
