//! Apis_authorization service for K8s provider
//!
...
impl<'a> Apis_authorizationService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "subjectaccessreview" => {
                self.plan_subjectaccessreview(current_state, desired_input)
                    .await
            }
            "selfsubjectaccessreview" => {
                self.plan_selfsubjectaccessreview(current_state, desired_input)
                    .await
            }
            "localsubjectaccessreview" => {
                self.plan_localsubjectaccessreview(current_state, desired_input)
                    .await
            }
            "v1" => self.plan_v1(current_state, desired_input).await,
            "selfsubjectrulesreview" => {
                self.plan_selfsubjectrulesreview(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_authorization", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "subjectaccessreview" => self.create_subjectaccessreview(input).await,
            "selfsubjectaccessreview" => self.create_selfsubjectaccessreview(input).await,
            "localsubjectaccessreview" => self.create_localsubjectaccessreview(input).await,
            "v1" => self.create_v1(input).await,
            "selfsubjectrulesreview" => self.create_selfsubjectrulesreview(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_authorization", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "subjectaccessreview" => self.read_subjectaccessreview(id).await,
            "selfsubjectaccessreview" => self.read_selfsubjectaccessreview(id).await,
            "localsubjectaccessreview" => self.read_localsubjectaccessreview(id).await,
            "v1" => self.read_v1(id).await,
            "selfsubjectrulesreview" => self.read_selfsubjectrulesreview(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_authorization", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "subjectaccessreview" => self.update_subjectaccessreview(id, input).await,
            "selfsubjectaccessreview" => self.update_selfsubjectaccessreview(id, input).await,
            "localsubjectaccessreview" => self.update_localsubjectaccessreview(id, input).await,
            "v1" => self.update_v1(id, input).await,
            "selfsubjectrulesreview" => self.update_selfsubjectrulesreview(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_authorization", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "subjectaccessreview" => self.delete_subjectaccessreview(id).await,
            "selfsubjectaccessreview" => self.delete_selfsubjectaccessreview(id).await,
            "localsubjectaccessreview" => self.delete_localsubjectaccessreview(id).await,
            "v1" => self.delete_v1(id).await,
            "selfsubjectrulesreview" => self.delete_selfsubjectrulesreview(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_authorization", resource_name
            ))),
    ...
    async fn create_subjectaccessreview(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a subjectaccessreview resource
    async fn read_subjectaccessreview(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_subjectaccessreview(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_selfsubjectaccessreview(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a selfsubjectaccessreview resource
    async fn read_selfsubjectaccessreview(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_selfsubjectaccessreview(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn read_localsubjectaccessreview(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_localsubjectaccessreview(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_selfsubjectrulesreview(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a selfsubjectrulesreview resource
    async fn read_selfsubjectrulesreview(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_selfsubjectrulesreview(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
}
