...
impl<'a> ApisService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "discovery" => self.plan_discovery(current_state, desired_input).await,
            "endpointslice" => self.plan_endpointslice(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "discovery" => self.create_discovery(input).await,
            "endpointslice" => self.create_endpointslice(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "discovery" => self.read_discovery(id).await,
            "endpointslice" => self.read_endpointslice(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "discovery" => self.update_discovery(id, input).await,
            "endpointslice" => self.update_endpointslice(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "discovery" => self.delete_discovery(id).await,
            "endpointslice" => self.delete_endpointslice(id).await,
    ...
    async fn create_discovery(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a discovery resource
    async fn read_discovery(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a discovery resource
    async fn update_discovery(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a discovery resource
    async fn delete_discovery(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_endpointslice(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a endpointslice resource
    async fn read_endpointslice(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a endpointslice resource
    async fn update_endpointslice(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a endpointslice resource
    async fn delete_endpointslice(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
