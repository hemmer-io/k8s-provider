//! Apis_admissionregistration service for K8s provider
//!
...
impl<'a> Apis_admissionregistrationService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "admissionregistration" => {
                self.plan_admissionregistration(current_state, desired_input)
                    .await
            }
            "mutatingadmissionpolicie" => {
                self.plan_mutatingadmissionpolicie(current_state, desired_input)
                    .await
            }
            "v1beta1" => self.plan_v1beta1(current_state, desired_input).await,
            "mutatingadmissionpolicybinding" => {
                self.plan_mutatingadmissionpolicybinding(current_state, desired_input)
                    .await
            }
            "mutatingadmissionpolicie" => {
                self.plan_mutatingadmissionpolicie(current_state, desired_input)
            ...
            "validatingwebhookconfiguration" => {
                self.plan_validatingwebhookconfiguration(current_state, desired_input)
                    .await
            }
            "validatingadmissionpolicie" => {
                self.plan_validatingadmissionpolicie(current_state, desired_input)
                    .await
            }
            "statu" => self.plan_statu(current_state, desired_input).await,
            "v1" => self.plan_v1(current_state, desired_input).await,
            "validatingadmissionpolicybinding" => {
                self.plan_validatingadmissionpolicybinding(current_state, desired_input)
                    .await
            }
            "mutatingwebhookconfiguration" => {
                self.plan_mutatingwebhookconfiguration(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_admissionregistration", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "admissionregistration" => self.create_admissionregistration(input).await,
            "mutatingadmissionpolicie" => self.create_mutatingadmissionpolicie(input).await,
            ...
            "validatingadmissionpolicie" => self.create_validatingadmissionpolicie(input).await,
            "statu" => self.create_statu(input).await,
            "v1" => self.create_v1(input).await,
            "validatingadmissionpolicybinding" => {
                self.create_validatingadmissionpolicybinding(input).await
            }
            "mutatingwebhookconfiguration" => self.create_mutatingwebhookconfiguration(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_admissionregistration", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "admissionregistration" => self.read_admissionregistration(id).await,
            "mutatingadmissionpolicie" => self.read_mutatingadmissionpolicie(id).await,
            "v1beta1" => self.read_v1beta1(id).await,
            "mutatingadmissionpolicybinding" => self.read_mutatingadmissionpolicybinding(id).await,
            "mutatingadmissionpolicie" => self.read_mutatingadmissionpolicie(id).await,
            "mutatingadmissionpolicybinding" => self.read_mutatingadmissionpolicybinding(id).await,
            "v1alpha1" => self.read_v1alpha1(id).await,
            "validatingwebhookconfiguration" => self.read_validatingwebhookconfiguration(id).await,
            "validatingadmissionpolicie" => self.read_validatingadmissionpolicie(id).await,
            "statu" => self.read_statu(id).await,
            "v1" => self.read_v1(id).await,
            "validatingadmissionpolicybinding" => {
                self.read_validatingadmissionpolicybinding(id).await
            }
            "mutatingwebhookconfiguration" => self.read_mutatingwebhookconfiguration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_admissionregistration", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "admissionregistration" => self.update_admissionregistration(id, input).await,
            "mutatingadmissionpolicie" => self.update_mutatingadmissionpolicie(id, input).await,
            ...
            "validatingadmissionpolicie" => self.update_validatingadmissionpolicie(id, input).await,
            "statu" => self.update_statu(id, input).await,
            "v1" => self.update_v1(id, input).await,
            "validatingadmissionpolicybinding" => {
                self.update_validatingadmissionpolicybinding(id, input)
                    .await
            }
            "mutatingwebhookconfiguration" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "admissionregistration" => self.delete_admissionregistration(id).await,
            "mutatingadmissionpolicie" => self.delete_mutatingadmissionpolicie(id).await,
            ...
            "validatingadmissionpolicie" => self.delete_validatingadmissionpolicie(id).await,
            "statu" => self.delete_statu(id).await,
            "v1" => self.delete_v1(id).await,
            "validatingadmissionpolicybinding" => {
                self.delete_validatingadmissionpolicybinding(id).await
            }
            "mutatingwebhookconfiguration" => self.delete_mutatingwebhookconfiguration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_admissionregistration", resource_name
            ))),
    ...
    async fn create_admissionregistration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a admissionregistration resource
    async fn read_admissionregistration(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
    ...
    async fn delete_admissionregistration(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn read_mutatingadmissionpolicie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_mutatingadmissionpolicie(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn read_mutatingadmissionpolicybinding(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_mutatingadmissionpolicybinding(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn read_validatingwebhookconfiguration(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_validatingwebhookconfiguration(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn read_validatingadmissionpolicie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_validatingadmissionpolicie(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn read_validatingadmissionpolicybinding(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_validatingadmissionpolicybinding(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn read_mutatingwebhookconfiguration(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_mutatingwebhookconfiguration(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
}
