//! Mutatingadmissionpolicybinding resource
//!
...
/// Mutatingadmissionpolicybinding resource handler
pub struct Mutatingadmissionpolicybinding<'a> {
    provider: &'a crate::KubernetesProvider,
}

impl<'a> Mutatingadmissionpolicybinding<'a> {
    pub(crate) fn new(provider: &'a crate::KubernetesProvider) -> Self {
        Self { provider }
    }


    /// Create a new mutatingadmissionpolicybinding
    ///
    ...
    /// Read/describe a mutatingadmissionpolicybinding
    ///
    ...
    /// Update a mutatingadmissionpolicybinding
    ///
...
mod tests {
    ...
    #[tokio::test]
    async fn test_mutatingadmissionpolicybinding_operations() {
        // Test mutatingadmissionpolicybinding CRUD operations
    }
}
