//! Mutatingadmissionpolicie resource
//!
...
/// Mutatingadmissionpolicie resource handler
pub struct Mutatingadmissionpolicie<'a> {
    provider: &'a crate::K8sProvider,
}

impl<'a> Mutatingadmissionpolicie<'a> {
    pub(crate) fn new(provider: &'a crate::K8sProvider) -> Self {
        Self { provider }
    }


    /// Create a new mutatingadmissionpolicie
    ///
    ...
    /// Read/describe a mutatingadmissionpolicie
    ///
    ...
    /// Update a mutatingadmissionpolicie
    ///
    ...
    /// Delete a mutatingadmissionpolicie
    ///
    /// TODO: Map `id` parameter to appropriate SDK field(s)
    #[allow(unused_variables)]
...
mod tests {
    ...
    #[tokio::test]
    async fn test_mutatingadmissionpolicie_operations() {
        // Test mutatingadmissionpolicie CRUD operations
    }
}
