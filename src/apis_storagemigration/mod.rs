//! Apis_storagemigration service for K8s provider
//!
...
impl<'a> Apis_storagemigrationService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "storagemigration" => {
                self.plan_storagemigration(current_state, desired_input)
                    .await
            }
            "statu" => self.plan_statu(current_state, desired_input).await,
            "v1beta1" => self.plan_v1beta1(current_state, desired_input).await,
            "storageversionmigration" => {
                self.plan_storageversionmigration(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_storagemigration", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "storagemigration" => self.create_storagemigration(input).await,
            "statu" => self.create_statu(input).await,
            "v1beta1" => self.create_v1beta1(input).await,
            "storageversionmigration" => self.create_storageversionmigration(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_storagemigration", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "storagemigration" => self.read_storagemigration(id).await,
            "statu" => self.read_statu(id).await,
            "v1beta1" => self.read_v1beta1(id).await,
            "storageversionmigration" => self.read_storageversionmigration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_storagemigration", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "storagemigration" => self.update_storagemigration(id, input).await,
            "statu" => self.update_statu(id, input).await,
            "v1beta1" => self.update_v1beta1(id, input).await,
            "storageversionmigration" => self.update_storageversionmigration(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_storagemigration", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "storagemigration" => self.delete_storagemigration(id).await,
            "statu" => self.delete_statu(id).await,
            "v1beta1" => self.delete_v1beta1(id).await,
            "storageversionmigration" => self.delete_storageversionmigration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_storagemigration", resource_name
            ))),
    ...
    async fn create_storagemigration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a storagemigration resource
    async fn read_storagemigration(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
    ...
    async fn delete_storagemigration(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_storageversionmigration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a storageversionmigration resource
    async fn read_storageversionmigration(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_storageversionmigration(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
}
