//! Apis_certificates service for K8s provider
//!
...
impl<'a> Apis_certificatesService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "clustertrustbundle" => {
                self.plan_clustertrustbundle(current_state, desired_input)
                    .await
            }
            "podcertificaterequest" => {
                self.plan_podcertificaterequest(current_state, desired_input)
                    .await
            }
            ...
            "approval" => self.plan_approval(current_state, desired_input).await,
            "certificatesigningrequest" => {
                self.plan_certificatesigningrequest(current_state, desired_input)
                    .await
            }
            "statu" => self.plan_statu(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "apis_certificates", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "clustertrustbundle" => self.create_clustertrustbundle(input).await,
            "podcertificaterequest" => self.create_podcertificaterequest(input).await,
            "statu" => self.create_statu(input).await,
            "certificate" => self.create_certificate(input).await,
            "approval" => self.create_approval(input).await,
            "certificatesigningrequest" => self.create_certificatesigningrequest(input).await,
            "statu" => self.create_statu(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "clustertrustbundle" => self.read_clustertrustbundle(id).await,
            "podcertificaterequest" => self.read_podcertificaterequest(id).await,
            "statu" => self.read_statu(id).await,
            "certificate" => self.read_certificate(id).await,
            "approval" => self.read_approval(id).await,
            "certificatesigningrequest" => self.read_certificatesigningrequest(id).await,
            "statu" => self.read_statu(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "clustertrustbundle" => self.update_clustertrustbundle(id, input).await,
            "podcertificaterequest" => self.update_podcertificaterequest(id, input).await,
            "statu" => self.update_statu(id, input).await,
            "certificate" => self.update_certificate(id, input).await,
            "approval" => self.update_approval(id, input).await,
            "certificatesigningrequest" => self.update_certificatesigningrequest(id, input).await,
            "statu" => self.update_statu(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "clustertrustbundle" => self.delete_clustertrustbundle(id).await,
            "podcertificaterequest" => self.delete_podcertificaterequest(id).await,
            "statu" => self.delete_statu(id).await,
            "certificate" => self.delete_certificate(id).await,
            "approval" => self.delete_approval(id).await,
            "certificatesigningrequest" => self.delete_certificatesigningrequest(id).await,
            "statu" => self.delete_statu(id).await,
    ...
    async fn create_clustertrustbundle(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a clustertrustbundle resource
    async fn read_clustertrustbundle(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_clustertrustbundle(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_podcertificaterequest(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a podcertificaterequest resource
    async fn read_podcertificaterequest(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_podcertificaterequest(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_approval(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a approval resource
    async fn read_approval(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a approval resource
    async fn update_approval(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a approval resource
    async fn delete_approval(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn read_certificatesigningrequest(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_certificatesigningrequest(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
