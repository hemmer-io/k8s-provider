...
/// Certificatesigningrequest resource handler
...
impl<'a> Certificatesigningrequest<'a> {
    ...
    /// Read/describe a certificatesigningrequest
    ///
...
mod tests {
    ...
    #[tokio::test]
    async fn test_certificatesigningrequest_operations() {
        // Test certificatesigningrequest CRUD operations
    }
}
