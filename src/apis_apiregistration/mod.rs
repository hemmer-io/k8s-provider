//! Apis_apiregistration service for K8s provider
//!
...
impl<'a> Apis_apiregistrationService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "apiservice" => self.plan_apiservice(current_state, desired_input).await,
            "statu" => self.plan_statu(current_state, desired_input).await,
            "v1" => self.plan_v1(current_state, desired_input).await,
            "apiregistration" => {
                self.plan_apiregistration(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_apiregistration", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "apiservice" => self.create_apiservice(input).await,
            "statu" => self.create_statu(input).await,
            "v1" => self.create_v1(input).await,
            "apiregistration" => self.create_apiregistration(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_apiregistration", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "apiservice" => self.read_apiservice(id).await,
            "statu" => self.read_statu(id).await,
            "v1" => self.read_v1(id).await,
            "apiregistration" => self.read_apiregistration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_apiregistration", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "apiservice" => self.update_apiservice(id, input).await,
            "statu" => self.update_statu(id, input).await,
            "v1" => self.update_v1(id, input).await,
            "apiregistration" => self.update_apiregistration(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_apiregistration", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "apiservice" => self.delete_apiservice(id).await,
            "statu" => self.delete_statu(id).await,
            "v1" => self.delete_v1(id).await,
            "apiregistration" => self.delete_apiregistration(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apis_apiregistration", resource_name
            ))),
    ...
    async fn create_apiservice(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a apiservice resource
    async fn read_apiservice(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a apiservice resource
    async fn update_apiservice(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a apiservice resource
    async fn delete_apiservice(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_apiregistration(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a apiregistration resource
    async fn read_apiregistration(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_apiregistration(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
}
