...
/// Deviceclasse resource handler
pub struct Deviceclasse<'a> {
    provider: &'a crate::KubernetesProvider,
}

impl<'a> Deviceclasse<'a> {
    pub(crate) fn new(provider: &'a crate::KubernetesProvider) -> Self {
        Self { provider }
    }


    /// Create a new deviceclasse
    ///
...
mod tests {
    ...
    #[tokio::test]
    async fn test_deviceclasse_operations() {
        // Test deviceclasse CRUD operations
    }
}
