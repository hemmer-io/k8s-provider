...
/// Resourceslice resource handler
...
mod tests {
    ...
    #[tokio::test]
    async fn test_resourceslice_operations() {
        // Test resourceslice CRUD operations
    }
}
