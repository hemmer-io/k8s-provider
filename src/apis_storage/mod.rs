//! Apis_storage service for K8s provider
//!
...
impl<'a> Apis_storageService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "csinode" => self.plan_csinode(current_state, desired_input).await,
            "volumeattachment" => {
                self.plan_volumeattachment(current_state, desired_input)
                    .await
            }
            "csistoragecapacitie" => {
                self.plan_csistoragecapacitie(current_state, desired_input)
                    .await
            }
            "storageclasse" => self.plan_storageclasse(current_state, desired_input).await,
            ...
            "volumeattributesclasse" => {
                self.plan_volumeattributesclasse(current_state, desired_input)
                    .await
            }
            "csidriver" => self.plan_csidriver(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "csinode" => self.create_csinode(input).await,
            "volumeattachment" => self.create_volumeattachment(input).await,
            "csistoragecapacitie" => self.create_csistoragecapacitie(input).await,
            "storageclasse" => self.create_storageclasse(input).await,
            "statu" => self.create_statu(input).await,
            "v1" => self.create_v1(input).await,
            "volumeattributesclasse" => self.create_volumeattributesclasse(input).await,
            "csidriver" => self.create_csidriver(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "csinode" => self.read_csinode(id).await,
            "volumeattachment" => self.read_volumeattachment(id).await,
            "csistoragecapacitie" => self.read_csistoragecapacitie(id).await,
            "storageclasse" => self.read_storageclasse(id).await,
            "statu" => self.read_statu(id).await,
            "v1" => self.read_v1(id).await,
            "volumeattributesclasse" => self.read_volumeattributesclasse(id).await,
            "csidriver" => self.read_csidriver(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "csinode" => self.update_csinode(id, input).await,
            "volumeattachment" => self.update_volumeattachment(id, input).await,
            "csistoragecapacitie" => self.update_csistoragecapacitie(id, input).await,
            "storageclasse" => self.update_storageclasse(id, input).await,
            "statu" => self.update_statu(id, input).await,
            "v1" => self.update_v1(id, input).await,
            "volumeattributesclasse" => self.update_volumeattributesclasse(id, input).await,
            "csidriver" => self.update_csidriver(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "csinode" => self.delete_csinode(id).await,
            "volumeattachment" => self.delete_volumeattachment(id).await,
            "csistoragecapacitie" => self.delete_csistoragecapacitie(id).await,
            "storageclasse" => self.delete_storageclasse(id).await,
            "statu" => self.delete_statu(id).await,
            "v1" => self.delete_v1(id).await,
            "volumeattributesclasse" => self.delete_volumeattributesclasse(id).await,
            "csidriver" => self.delete_csidriver(id).await,
    ...
    async fn create_csinode(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a csinode resource
    async fn read_csinode(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a csinode resource
    async fn update_csinode(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a csinode resource
    async fn delete_csinode(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_volumeattachment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a volumeattachment resource
    async fn read_volumeattachment(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_volumeattachment(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_csistoragecapacitie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a csistoragecapacitie resource
    async fn read_csistoragecapacitie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_csistoragecapacitie(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_storageclasse(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a storageclasse resource
    async fn read_storageclasse(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a storageclasse resource
    async fn update_storageclasse(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a storageclasse resource
    async fn delete_storageclasse(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_volumeattributesclasse(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a volumeattributesclasse resource
    async fn read_volumeattributesclasse(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_volumeattributesclasse(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_csidriver(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a csidriver resource
    async fn read_csidriver(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a csidriver resource
    async fn update_csidriver(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a csidriver resource
    async fn delete_csidriver(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
