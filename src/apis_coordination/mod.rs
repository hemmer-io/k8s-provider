//! Apis_coordination service for K8s provider
//!
...
impl<'a> Apis_coordinationService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "coordination" => self.plan_coordination(current_state, desired_input).await,
            "leasecandidate" => self.plan_leasecandidate(current_state, desired_input).await,
            "v1alpha2" => self.plan_v1alpha2(current_state, desired_input).await,
            "lease" => self.plan_lease(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "apis_coordination", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "coordination" => self.create_coordination(input).await,
            "leasecandidate" => self.create_leasecandidate(input).await,
            "v1alpha2" => self.create_v1alpha2(input).await,
            "lease" => self.create_lease(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "coordination" => self.read_coordination(id).await,
            "leasecandidate" => self.read_leasecandidate(id).await,
            "v1alpha2" => self.read_v1alpha2(id).await,
            "lease" => self.read_lease(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "coordination" => self.update_coordination(id, input).await,
            "leasecandidate" => self.update_leasecandidate(id, input).await,
            "v1alpha2" => self.update_v1alpha2(id, input).await,
            "lease" => self.update_lease(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "coordination" => self.delete_coordination(id).await,
            "leasecandidate" => self.delete_leasecandidate(id).await,
            "v1alpha2" => self.delete_v1alpha2(id).await,
            "lease" => self.delete_lease(id).await,
    ...
    async fn create_coordination(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a coordination resource
    async fn read_coordination(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a coordination resource
    async fn update_coordination(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a coordination resource
    async fn delete_coordination(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_leasecandidate(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a leasecandidate resource
    async fn read_leasecandidate(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_leasecandidate(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_v1alpha2(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a v1alpha2 resource
    async fn read_v1alpha2(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a v1alpha2 resource
    async fn update_v1alpha2(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a v1alpha2 resource
    async fn delete_v1alpha2(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
    ...
    async fn create_lease(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a lease resource
    async fn read_lease(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a lease resource
    async fn update_lease(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Kubernetes SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a lease resource
    async fn delete_lease(&self, id: &str) -> Result<()> {
        // TODO: Implement Kubernetes SDK calls
        Ok(())
    }
