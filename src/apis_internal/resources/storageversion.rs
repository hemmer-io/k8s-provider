...
/// Storageversion resource handler
...
impl<'a> Storageversion<'a> {
    ...
    /// Read/describe a storageversion
    ///
...
mod tests {
    ...
    #[tokio::test]
    async fn test_storageversion_operations() {
        // Test storageversion CRUD operations
    }
}
