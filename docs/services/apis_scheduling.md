...
The apis_scheduling service provides access to 3 resource types:

- [Priorityclasse](#priorityclasse) [CRUD]
- [V1](#v1) [R]
...
# Create priorityclasse
priorityclasse = provider.apis_scheduling.Priorityclasse {
}

# Access priorityclasse outputs
priorityclasse_id = priorityclasse.id
```
...
# Create multiple priorityclasse resources
priorityclasse_0 = provider.apis_scheduling.Priorityclasse {
}
priorityclasse_1 = provider.apis_scheduling.Priorityclasse {
}
priorityclasse_2 = provider.apis_scheduling.Priorityclasse {
}
```
...
- [Kubernetes Apis_scheduling Documentation](https://kubernetes.io/docs/reference/kubernetes-api/)
