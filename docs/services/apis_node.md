...
The apis_node service provides access to 3 resource types:

- [V1](#v1) [R]
- [Runtimeclasse](#runtimeclasse) [CRUD]
- [Node](#node) [R]
...
# Create runtimeclasse
runtimeclasse = provider.apis_node.Runtimeclasse {
}

# Access runtimeclasse outputs
runtimeclasse_id = runtimeclasse.id
```
...
v1_0 = provider.apis_node.V1 {
}
v1_1 = provider.apis_node.V1 {
}
v1_2 = provider.apis_node.V1 {
}
```
...
- [Kubernetes Apis_node Documentation](https://kubernetes.io/docs/reference/kubernetes-api/)
