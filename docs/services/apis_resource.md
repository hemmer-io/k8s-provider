...
# Create deviceclasse
deviceclasse = provider.apis_resource.Deviceclasse {
}

# Access deviceclasse outputs
deviceclasse_id = deviceclasse.id
```
...
# Access v1beta2 outputs
v1beta2_id = v1beta2.id
```
...
- [Kubernetes Apis_resource Documentation](https://kubernetes.io/docs/reference/kubernetes-api/)
