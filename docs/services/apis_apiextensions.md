...
customresourcedefinition = provider.apis_apiextensions.Customresourcedefinition {
}
...
# Access apiextension outputs
apiextension_id = apiextension.id
```
...
- [Kubernetes Apis_apiextensions Documentation](https://kubernetes.io/docs/reference/kubernetes-api/)
