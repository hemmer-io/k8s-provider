...
poddisruptionbudget = provider.apis_policy.Poddisruptionbudget {
}

# Access poddisruptionbudget outputs
poddisruptionbudget_id = poddisruptionbudget.id
```
...
- [Kubernetes Apis_policy Documentation](https://kubernetes.io/docs/reference/kubernetes-api/)
