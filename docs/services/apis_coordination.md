...
# Create leasecandidate
leasecandidate = provider.apis_coordination.Leasecandidate {
}
...
# Create lease
lease = provider.apis_coordination.Lease {
}

# Access lease outputs
lease_id = lease.id
```
...
# Create multiple coordination resources
coordination_0 = provider.apis_coordination.Coordination {
}
coordination_1 = provider.apis_coordination.Coordination {
}
coordination_2 = provider.apis_coordination.Coordination {
}
```
...
if environment == "production":
    coordination = provider.apis_coordination.Coordination {
    }
```
...
- [Kubernetes Apis_coordination Documentation](https://kubernetes.io/docs/reference/kubernetes-api/)
